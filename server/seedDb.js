...
const seedDb = async () => {
  ...
  const [
    ...
    createProductService({
      ...
      image: "https://m.media-amazon.com/images/I/41yK8hvjvBL._SX342_SY445_.jpg",
      price: 10.99,
      is_featured: true
    }),
    createProductService({
      ...
      qty: 3,
      category: "gadgets",
      description: "6-inch multitool, Best Dad Ever inscription on case, screwdriver, wirecutter/stripper, plier",
